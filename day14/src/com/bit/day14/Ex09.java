...
//		for (int i = 0; i < 99999; i++) {
			...
			System.out.print(1900 + now.getYear() + "년"); // getYear은 2020-1900
			System.out.print(now.getMonth() + "월");
...
//		}
		...
		System.out.print(1900 + now2.getYear() + "년"); // getYear은 2020-1900
		System.out.print(now2.getMonth() + "월");
